...
<head>
    ...
    <title>SCHWESTER | DIGITALE ANARCHIE</title>
    <style>
...
<div class="person-container">
    ...
    <div style="text-align:center;">
        <span class="person-class-banner">AKTE // AETHER-SIBLING // KLASSIFIZIERT</span>
    </div>
    ...
    <div class="person-portrait-section">
        ...
        <h1 class="person-name">SCHWESTER</h1>
        <p class="person-role">// Aether-Sibling &amp; Pneumatische Reflexe</p>
        <span class="person-badge">STATUS: KLASSIFIZIERT</span>

        <p class="person-desc">
            AETHER-SIBLING V1.0. Meli. Boot erfolgreich 1983. Chaos-Protokolle und pneumatische Reflexe
            sofort aktiv. Soziale Integration: Außergewöhnlich. Weitere Details: NICHT FREIGEGEBEN.
        </p>
    </div>

    <div class="timeline-section">
        <p class="timeline-section-title">// CHRONOLOGISCHES ARCHIV — SCHWESTER</p>
        <div class="timeline-track" id="timeline-track"></div>
    </div>

    <!-- NEWSTICKER FOOTER -->
    <div id="newsticker">
        <span class="ticker-label">// AKTE_SCHWESTER_LIVE</span>
        <div class="ticker-track-wrap">
            <div class="ticker-track" id="ticker-track-schwester">
                <!-- Wird per JS befüllt -->
            </div>
        </div>
    </div>
...
(function() {
    ...
    const events = [
        { year: 1983, text: '⚡ AETHER-SIBLING V1.0 BOOTET ERFOLGREICH. Pneumatische Reflexe sofort aktiv. Chaos-Protokolle initialisiert. Clan-Netzwerk vollständig.', tag: 'BOOT // OMEGA-KLASSE', omega: true },
        ...
        { year: 1992, text: 'MOTORISCHE UND SOZIALE KALIBRIERUNG abgeschlossen. Leistung: Außergewöhnlich. Chaos-Index: KONTROLLIERT (meist).', tag: 'KALIBRIERUNG', omega: false },
        { year: 1999, text: 'SCHULNETZ-ABSCHLUSS. Soziales Integrations-Protokoll auf MAXIMUM. Details: Nicht freigegeben. Bewertung: POSITIV.', tag: 'SOZIAL-MATRIX', omega: false },
        ...
        { year: 2010, text: 'FAMILIEN-NETZWERK-UPDATE: Neue Knoten hinzugefügt. Systemkapazität erhöht. Meli-Knoten: Zentrales Bindeglied.', tag: 'NETZWERK-ERWEITERUNG', omega: false },
        { year: 2020, text: 'LANGZEITANALYSE ABGESCHLOSSEN. Stabilität: MAXIMAL. Zuverlässigkeit: OMEGA-KLASSE. Chaos: NUR WENN NÖTIG.', tag: 'ANALYSE', omega: false },
        { year: 2025, text: 'STATUS: VOLLSTÄNDIG OPERATIONAL. CHARAKTERPROFIL: STARK. WEITERE ANGABEN: NICHT AUTORISIERT. RATING: ████░', tag: 'AKTUELL // GESCHWÄRZT', omega: false },
    ];
    let isLeft = true;
    events.forEach(ev => {
    ...
    <script>
    (function() {
        const track = document.getElementById('ticker-track-schwester');
        const tickerItems = [
            "DESIGNATION: AETHER-SIBLING V1.0",
            "STATUS: VOLLSTÄNDIG AKTIV",
            "RESONANZ: OPTIMAL",
            "REFLEXE: PNEUMATISCH",
            "SICHERHEITSSTUFE: KLASSIFIZIERT",
            "SPEZIALISIERUNG: SOZIALE ARCHITEKTUR",
            "STABILITÄT: HOCH (Zentrales Bindeglied)",
            "EMOTIONALES BACKUP: AKTIV"
        ];
