...
<body <?php body_class(); ?>>
        ...
        <div class="content-box">
            <div class="content-header">
                ...
                <div class="filter-controls">
                    ...
                    <button class="steampunk-card filter-btn" style="color: var(--accent-gold); border-color: var(--accent-gold); padding: 2px 8px; background: transparent; cursor: pointer; display: flex; align-items: center;"><a href="<?php echo get_template_directory_uri(); ?>/page-overlords.php" style="color: inherit; text-decoration: none;"><h3 style="margin: 0; font-size: 0.7rem;">OVERLORDS (FAMILIE)</h3></a></button>
    ...
    <div id="sys-widget">
        <div class="sys-widget-header">
            // SYS_STATUS
            <button id="sys-toggle" style="float:right; background:none; border:none; color:rgba(0,255,65,0.4); font-size:0.6rem; cursor:pointer; padding:0; margin-left:5px;">×</button>
        </div>
    ...
    <!-- SYS WIDGET TOGGLE ARROW -->
    <div id="sys-toggle-arrow" style="position:fixed; top:10px; right:10px; z-index:10000; display:none; cursor:pointer; color:#0f0; font-size:1.5rem;">▲</div>
